# Creating the Healthy Behaviors Data set
# Catalina Canizares
# 05-13-2023


# The following script aims to generate a clean data set that will focus on healthy 
# behaviors related to weight, diet, physical exercise, sexual behaviors, sleep. 
